"""Fixed tests for the subscription module to improve coverage."""
import asyncio
...
from unraid_api.subscription import Subscription, SubscriptionManager
...
@pytest.mark.asyncio
async def test_subscription_manager_subscribe_duplicate(subscription_manager):
...
@pytest.mark.asyncio
async def test_subscription_manager_unsubscribe_not_found(subscription_manager):
...
@pytest.mark.asyncio
async def test_subscription_manager_stop_all(subscription_manager):
...
def test_subscription_manager_get_subscription(subscription_manager):
...
def test_subscription_manager_get_subscription_not_found(subscription_manager):
